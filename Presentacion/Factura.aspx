                ...
                <div>
                    ...
                    <div class="form-group text-right">
                        <asp:LinkButton ID="lbNuevo" runat="server" CssClass="btn btn-primary" OnClick="lbNuevo_Click"
                            AutoPostBack="true">Nuevo</asp:LinkButton>
                        <asp:LinkButton ID="lbModificar" runat="server" CssClass="btn btn-primary" OnClick="lbModificar_Click"
                            AutoPostBack="false" Visible="false">Modificar</asp:LinkButton>
                        <asp:LinkButton ID="lbGrabar" runat="server" CssClass="btn btn-primary" OnClick="lbGrabar_Click"
                            AutoPostBack="true" Visible="false">Grabar</asp:LinkButton>
                        <asp:LinkButton ID="lbCancelar" runat="server" CssClass="btn btn-primary" OnClick="lbCancelar_Click"
                            AutoPostBack="true" Visible="false">Cancelar</asp:LinkButton>
                    </div>
                    <div class="well">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtBalance" runat="server" CssClass="form-control date" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-2">
                                ...
                                <div class="form-group">
                                    <div >
                                        <asp:GridView ID="gvDetalleVenta" runat="server"
                                            ...
                                            OnRowDeleting="gvDetalleVenta_RowDeleting" ShowFooter="true">
                                            <Columns>
